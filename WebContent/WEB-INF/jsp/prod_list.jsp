...
<body>
	...
	<div id="content">
		<div id="search_div">
			<form method="post" action="${pageContext.request.contextPath}/product/getList">
		...
		<c:forEach items="${list }" var="prod">
			...
			<div class="prod_div">
				...
				<a href ="${pageContext.request.contextPath}/product/getProduct?pid=${prod.id}" >
				...
				<div>
					<div id="gotocart_div">
						<a href="${pageContext.request.contextPath}/cart/addCart?buyNum=1&pid=${prod.id}">加入购物车</a>
					</div>					
					<div id="say_div">
						133人评价
					</div>					
