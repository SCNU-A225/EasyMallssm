CREATE DATABASE  IF NOT EXISTS `easymall` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `easymall`;
...
CREATE TABLE `cart` (
  ...
  `uid` int(11) NOT NULL,
  `pid` varchar(100) CHARACTER SET utf8 NOT NULL,
...
-- Dump completed on 2020-04-06 19:29:21
